...
level = input(f'Введите ваш уровень (например: оператор/специалист/старший специалист/ведущий специалист):')
if level == 'оператор':
    fact_salary = 40000
    normal_bonus = 10000
    print('Принято')
elif level == 'специалист':
    fact_salary = 40000
    normal_bonus = 18000
    print('Принято')
elif level == 'старший специалист':
    fact_salary = 40000
    normal_bonus = 28000
    print('Принято')
elif level == 'ведущий специалист':
    fact_salary = 40000
    normal_bonus = 33000
    print('Принято')
else:
    print('Программа вас не поняла, введите уровень в указанном формате и БЕЗ ПРОБЕЛОВ')
    level = (input(f'Введите ваш уровень (например: оператор/специалист/старший специалист/ведущий специалист):'))
...
if int(outflow_plan) > 0:
    ...
    print('Принято')
else: print('Принято, отток учитывать не будем')
work_days_plan = int(input(f'Введите общее количество рабочих дней: '))
print('Принято')
...
print('Принято')
weekends = int(input(f'Введите количество дней за свой счёт в этом месяце: '))
print('Принято')
